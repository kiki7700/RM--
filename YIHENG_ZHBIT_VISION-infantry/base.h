...
#define GIMBAL_BAUD B115200
#define CAMERA0_PATH "/dev/video0"
#define CAMERA1_PATH "/dev/video0"
...
//在笔记本离线调试时视频路径
//#define ARMOR_VIDEO_PATH "../Videos/test.avi" //装甲板
//#define BUFF_VIDEO_PATH "../Videos/test.avi"  //能量机关
struct OtherParam
{
